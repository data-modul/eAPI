 ...
 *+=========================================================================
 *I  $HeadURL: http://svn.code.sf.net/p/eapidk/code/trunk/include/CBCEEPROM.h $
 *+=========================================================================
...
typedef union COM0R10_BB_u{
	...
	struct COM0R10_BB_s{
		...
		uint8_t        MiscIo1               ; /* 0xD8 Miscellaneous \
							  I/O Descriptor Byte 1 */
		uint8_t        LanDesc               ; /* 0xD9 LAN Descriptor \
							  Byte */
		uint8_t        DispDesc              ; /* 0xDA Display \
							  Descriptor Byte */
		uint8_t        UsbDesc               ; /* 0xDB USB Descriptor \
							  Byte */
		uint8_t        ExpCardDesc0          ; /* 0xDC Express Card 0 \
							  Descriptor Byte */
		uint8_t        ExpCardDesc1          ; /* 0xDD Express Card 1 \
							  Descriptor Byte */
		uint8_t        SasDevDesc            ; /* 0xDE SAS Device \
							  Descriptor Byte */
		uint8_t        FruRevision           ; /* 0xDF FRU Revision: \
							  fill with 00 for R1.0 */
		uint8_t        Identifier[0x10]      ; /* 0xE0 ASCII ID string:\
							  "COMExpressConfig" */
		uint8_t        Reserved2[0xFE - 0xF0]; /* 0xF0 Reserved */
		uint8_t        Checksum              ; /* 0xFE Unsigned 16 bit\
							  checksum over the
