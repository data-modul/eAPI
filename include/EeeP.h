 ...
 *+=========================================================================
 *I  $HeadURL: https://dedeg-sapp001:8443/svn/EMBEDDED-SW/Tools/UEFI/EDK2/trunk/DmoAppPkg/Include/Common/EeeP.h $
 *+=========================================================================
 *I     Copyright (c) 2015, DATA MODUL AG
 *I                   Martin Schrenkhammer, mschrenkhammer@data-modul.com
 *I
 *I     Copyright (c) 2002-2010, Kontron Embedded Modules GmbH
 *I                   John Kearney, John.Kearney@kontron.com
 *I
 ...
 *I  Last committed       : $Revision: 112 $
 *I  Last changed by      : $Author: MartinSc $
 *I  Last changed date    : $Date: 2015-06-18 15:32:55 +0200 (Do, 18 Jun 2015) $
 *I  ID                   : $Id: EeeP.h 112 2015-06-18 13:32:55Z MartinSc $
 *I
 *+=========================================================================
 *</KHeader>
 */
...
#  define EEEP_UINT64_C(x) ((uint64_t)(x))
...
typedef struct EeePSystemInfo_s{
    ...
    uint8_t Manufacturer   ; /* 0x07 Number of ASCIIZ String */
    uint8_t ProductName    ; /* 0x08 Number of ASCIIZ String */
    uint8_t Version        ; /* 0x09 Number of ASCIIZ String */
    uint8_t SerialNumber   ; /* 0x0A Number of ASCIIZ String */
    EeePGUID_t UUID        ; /* 0x0B Universal Unique ID number. */
    uint8_t Reserved0      ; /* 0x1B Reserved Set to Zero    */
    uint8_t SKU_Number     ; /* 0x1C Number of ASCIIZ String */
    uint8_t Family         ; /* 0x1D Number of ASCIIZ String */
}EeePSystemInfo_t;
...
typedef struct EeePModuleInfo_s{
    EeePSmbiosHdr_t SDBHdr; /* 0x00 Smbios Dynamic Block Header */
    uint8_t Manufacturer   ; /* 0x07 Number of ASCIIZ String */
    uint8_t Product        ; /* 0x08 Number of ASCIIZ String */
    uint8_t Version        ; /* 0x09 Number of ASCIIZ String */
    uint8_t SerialNumber   ; /* 0x0A Number of ASCIIZ String */
    uint8_t AssetTag       ; /* 0x0B Number of ASCIIZ String */
    uint8_t FeatureFlag    ; /* 0x0C A collection of 
                              *      flags that identify 
                              *      features of this 
                              *      baseboard.
                              *      +=======+=========================+
...
#       define SMBIOS_HOT_SWAP_CAP    EEEP_UINT8_C(1 << 4)
    uint8_t Location       ; /* 0x0D Number of ASCIIZ String */
    SmbiosHandle_t LocHdl  ; /* 0x0E Chassis Handle */
    SMBIOS_BoardTypes_t BoardType ; /* 0x10 SMBIOS_BoardTypes_t */
    uint8_t ContainedHndls ; /* 0x11 Number Of Contained 
                              *      Object Handles That 
                              *      Follow
                              */
    SmbiosHandle_t Handles[1] ; /* 0x12 Handles */
}EeePModuleInfo_t;
...
typedef struct EeePChassisInfo_s{
    EeePSmbiosHdr_t SDBHdr; /* 0x00 Smbios Dynamic Block Header */
    uint8_t Manufacturer   ; /* 0x07 Number of ASCIIZ String */
    ChassisTypes_t Type    ; /* 0x08 ENUM */
    uint8_t Version        ; /* 0x09 Number of ASCIIZ String */
    uint8_t SerialNumber   ; /* 0x0A Number of ASCIIZ String */
    uint8_t AssetTagNumber ; /* 0x0B Number of ASCIIZ String */
    uint8_t Reserved0[4]   ; /* 0x0C Reserved */
    EeePuint32u_t OEM      ; /* 0x10 Contains OEM- or BIOS 
                              * vendor-specific information 
                              */
    uint8_t Height         ; /* 0x14 The height of the  
                              * enclosure, in 'U's.  
                              */
    uint8_t NumPowerCords  ; /* 0x15 Identifies the number   
                              * of power cords associated with  
                              * the enclosure or chassis. 
                              */
    uint8_t CElementCnt    ; /* 0x16 Contained Element Count */   
    uint8_t CElementSize   ; /* 0x17 Contained Element Size  */   
    CCElement_t CElement[1]; /* 0x18 Contained Element(s) */   
}EeePChassisInfo_t;
